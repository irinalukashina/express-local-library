...
exports.author_update_post = function(req, res) {
    ...
    //req.checkBody('date_of_birth', 'Invalid date').optional({ checkFalsy: true }).isValid();
   // req.checkBody('date_of_death', 'Invalid date').optional({ checkFalsy: true }).isValid;
	
    console.log('date_of_death:'+req.body.date_of_death);
